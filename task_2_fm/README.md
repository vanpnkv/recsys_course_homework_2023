...
## Дедлайн
Работы принимаются до **30 ноября 2023 (четверг)**.
...
- Подберите гиперпараметр размерности для FM. В качестве метрики считайте **log-loss** и **auc**.
